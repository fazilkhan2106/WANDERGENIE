...
import FeaturedGuides from "../components/FeatureGuides";
...
const HomeScreen = () => {
  ...
  const fetchTrips = useCallback(async () => {
    try {
      ...
      const response = await axios.get("http://10.104.122.6:3000/api/trips", {
    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="flex-1">
        ...
        <View className="flex-row justify-between items-center px-4 pt-4 pb-2">
          <Image
            source={require("../assets/brand/myorignallogo.png")}
            style={{ width: 160, height: 40 }} //className="w-38 h-8"
            resizeMode="contain"
          />
